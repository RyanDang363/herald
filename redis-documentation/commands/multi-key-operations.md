...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"configurations","title":"Configurations"},{"id":"command-behaviors","title":"Command behaviors"},{"id":"read-only-commands","title":"Read-only commands"},{"id":"read-write-commands","title":"Read-write commands"},{"id":"pipelines-transactions-and-scripts","title":"Pipelines, transactions, and scripts"},{"children":[{"id":"single-instance-no-clustering","title":"Single Instance (No Clustering)"},{"id":"clustered-environments","title":"Clustered Environments"},{"id":"active-active-databases","title":"Active-Active Databases"}],"id":"examples-by-configuration","title":"Examples by Configuration"},{"children":[{"id":"common-error-messages","title":"Common Error Messages"},{"id":"solutions","title":"Solutions"}],"id":"troubleshooting-multi-key-operations","title":"Troubleshooting Multi-Key Operations"},{"id":"performance-considerations","title":"Performance Considerations"}]}
