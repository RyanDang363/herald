...
```json metadata
{
  "title": "Redis 8.8 Commands Reference",
  ...
  "tableOfContents": {"sections":[{"id":"quick-navigation","title":"Quick Navigation"},{"id":"string-commands","title":"String commands"},{"id":"hash-commands","title":"Hash commands"},{"id":"list-commands","title":"List commands"},{"id":"set-commands","title":"Set commands"},{"id":"sorted-set-commands","title":"Sorted set commands"},{"id":"stream-commands","title":"Stream commands"},{"id":"bitmap-commands","title":"Bitmap commands"},{"id":"array-commands","title":"Array commands"},{"id":"hyperloglog-commands","title":"HyperLogLog commands"},{"id":"geospatial-commands","title":"Geospatial commands"},{"id":"json-commands","title":"JSON commands"},{"id":"search-commands","title":"Search commands"},{"id":"time-series-commands","title":"Time series commands"},{"id":"vector-set-commands","title":"Vector set commands"},{"id":"pubsub-commands","title":"Pub/Sub commands"},{"id":"transaction-commands","title":"Transaction commands"},{"id":"scripting-commands","title":"Scripting commands"},{"id":"connection-commands","title":"Connection commands"},{"id":"server-commands","title":"Server commands"},{"id":"cluster-commands","title":"Cluster commands"},{"id":"generic-commands","title":"Generic commands"}]}
...
<details>
<summary><strong><a href="/commands/delex/">DELEX</a></strong> - Conditionally removes the specified key based on value or hash digest comparison.</summary>

**Syntax:** `DELEX key [IFEQ ifeq-value | IFNE ifne-value | IFDEQ ifdeq-digest |
  IFDNE ifdne-digest]`
...
<details>
<summary><strong><a href="/commands/digest/">DIGEST</a></strong> - Returns the hash digest of a string value as a hexadecimal string.</summary>
...
<details>
<summary><strong><a href="/commands/increx/">INCREX</a></strong> - Increments the numeric value of a key by a number and sets its expiration time. Uses 0 as initial value if the key doesn't exist. <span style="color: #e74c3c;">⭐ New in 8.8</span></summary>

**Syntax:** `INCREX key [BYFLOAT float | BYINT integer]
...
**Description:** Increments the numeric value of a key by a number and sets its expiration time. Uses 0 as initial value if the key doesn't exist.
...
<details>
<summary><strong><a href="/commands/msetex/">MSETEX</a></strong> - Atomically sets multiple string keys with a shared expiration in a single operation.</summary>

**Syntax:** `MSETEX numkeys key value [key value ...] [NX | XX] [EX seconds |
...
<details>
<summary><strong><a href="/commands/hgetdel/">HGETDEL</a></strong> - Returns the value of a field and deletes it from the hash.</summary>
...
<details>
<summary><strong><a href="/commands/hgetex/">HGETEX</a></strong> - Get the value of one or more fields of a given hash key, and optionally set their expiration.</summary>
...
<details>
<summary><strong><a href="/commands/hsetex/">HSETEX</a></strong> - Set the value of one or more fields of a given hash key, and optionally set their expiration.</summary>
...
<details>
<summary><strong><a href="/commands/xackdel/">XACKDEL</a></strong> - Acknowledges and conditionally deletes one or multiple entries for a stream consumer group.</summary>
...
**Syntax:** `XADD key [NOMKSTREAM] [KEEPREF | DELREF | ACKED]
...
<details>
<summary><strong><a href="/commands/xcfgset/">XCFGSET</a></strong> - Sets the IDMP configuration parameters for a stream.</summary>

**Syntax:** `XCFGSET key [IDMP-DURATION idmp-duration]
  [IDMP-MAXSIZE idmp-maxsize]`
...
<details>
<summary><strong><a href="/commands/xdelex/">XDELEX</a></strong> - Deletes one or multiple entries from the stream.</summary>
...
<details>
<summary><strong><a href="/commands/xidmprecord/">XIDMPRECORD</a></strong> - An internal command for setting IDMP metadata on an existing stream message. <span style="color: #e74c3c;">⭐ New in 8.8</span></summary>

**Syntax:** `XIDMPRECORD key pid iid stream-id`
...
<details>
<summary><strong><a href="/commands/xnack/">XNACK</a></strong> - Releases pending messages back to the group's PEL without acknowledging them, making them available for re-delivery. <span style="color: #e74c3c;">⭐ New in 8.8</span></summary>

**Syntax:** `XNACK key group <SILENT | FAIL | FATAL> IDS numids id [id ...]
  [RETRYCOUNT count] [FORCE]`

**Description:** Releases pending messages back to the group's PEL without acknowledging them, making them available for re-delivery.
...
Array commands operate on arrays of strings.

<details>
<summary><strong><a href="/commands/arcount/">ARCOUNT</a></strong> - Returns the number of non-empty elements in an array. <span style="color: #e74c3c;">⭐ New in 8.8</span></summary>
...
<details>
<summary><strong><a href="/commands/ardel/">ARDEL</a></strong> - Deletes elements at the specified indices in an array. <span style="color: #e74c3c;">⭐ New in 8.8</span></summary>

**Syntax:** `ARDEL key index [index ...]`
...
<details>
<summary><strong><a href="/commands/ardelrange/">ARDELRANGE</a></strong> - Deletes elements in one or more ranges. <span style="color: #e74c3c;">⭐ New in 8.8</span></summary>

**Syntax:** `ARDELRANGE key start end [start end ...]`
...
<details>
<summary><strong><a href="/commands/arget/">ARGET</a></strong> - Gets the value at an index in an array. <span style="color: #e74c3c;">⭐ New in 8.8</span></summary>

**Syntax:** `ARGET key index`
...
<details>
<summary><strong><a href="/commands/argetrange/">ARGETRANGE</a></strong> - Gets values in a range of indices. <span style="color: #e74c3c;">⭐ New in 8.8</span></summary>

**Syntax:** `ARGETRANGE key start end`
...
<details>
<summary><strong><a href="/commands/argrep/">ARGREP</a></strong> - Searches array elements in a range using textual predicates. <span style="color: #e74c3c;">⭐ New in 8.8</span></summary>

**Syntax:** `ARGREP key start end
...
<details>
<summary><strong><a href="/commands/arinfo/">ARINFO</a></strong> - Returns metadata about an array. <span style="color: #e74c3c;">⭐ New in 8.8</span></summary>

**Syntax:** `ARINFO key [FULL]`
...
<details>
<summary><strong><a href="/commands/arinsert/">ARINSERT</a></strong> - Inserts one or more values at consecutive indices. <span style="color: #e74c3c;">⭐ New in 8.8</span></summary>

**Syntax:** `ARINSERT key value [value ...]`
...
<details>
<summary><strong><a href="/commands/arlastitems/">ARLASTITEMS</a></strong> - Returns the most recently inserted elements. <span style="color: #e74c3c;">⭐ New in 8.8</span></summary>

**Syntax:** `ARLASTITEMS key count [REV]`
...
<details>
<summary><strong><a href="/commands/arlen/">ARLEN</a></strong> - Returns the length of an array (max index + 1). <span style="color: #e74c3c;">⭐ New in 8.8</span></summary>
...
<details>
<summary><strong><a href="/commands/armget/">ARMGET</a></strong> - Gets values at multiple indices in an array. <span style="color: #e74c3c;">⭐ New in 8.8</span></summary>

**Syntax:** `ARMGET key index [index ...]`
...
<details>
<summary><strong><a href="/commands/armset/">ARMSET</a></strong> - Sets multiple index-value pairs in an array. <span style="color: #e74c3c;">⭐ New in 8.8</span></summary>

**Syntax:** `ARMSET key index value [index value ...]`
...
<details>
<summary><strong><a href="/commands/arnext/">ARNEXT</a></strong> - Returns the next index ARINSERT would use. <span style="color: #e74c3c;">⭐ New in 8.8</span></summary>
...
<details>
<summary><strong><a href="/commands/arop/">AROP</a></strong> - Performs aggregate operations on array elements in a range. <span style="color: #e74c3c;">⭐ New in 8.8</span></summary>

**Syntax:** `AROP key start end <SUM | MIN | MAX | AND | OR | XOR | MATCH value |
  USED>`
...
<details>
<summary><strong><a href="/commands/arring/">ARRING</a></strong> - Inserts values into a ring buffer of specified size, wrapping and truncating as needed. <span style="color: #e74c3c;">⭐ New in 8.8</span></summary>

**Syntax:** `ARRING key size value [value ...]`
...
<details>
<summary><strong><a href="/commands/arscan/">ARSCAN</a></strong> - Iterates existing elements in a range, returning index-value pairs. <span style="color: #e74c3c;">⭐ New in 8.8</span></summary>

**Syntax:** `ARSCAN key start end [LIMIT limit]`
...
<details>
<summary><strong><a href="/commands/arseek/">ARSEEK</a></strong> - Sets the ARINSERT / ARRING cursor to a specific index. <span style="color: #e74c3c;">⭐ New in 8.8</span></summary>

**Syntax:** `ARSEEK key index`
...
<details>
<summary><strong><a href="/commands/arset/">ARSET</a></strong> - Sets one or more contiguous values starting at an index in an array. <span style="color: #e74c3c;">⭐ New in 8.8</span></summary>

**Syntax:** `ARSET key index value [value ...]`
...
<details>
<summary><strong><a href="/commands/json.objkeys/">JSON.OBJKEYS</a></strong> - Returns the key names of JSON objects at the paths matching a given path expression</summary>
...
<details>
<summary><strong><a href="/commands/json.objlen/">JSON.OBJLEN</a></strong> - Returns the number of keys in JSON objects at the paths matching a given path expression</summary>
...
**Syntax:** `JSON.SET key path value [NX | XX] [FPHA <FP16 | BF16 | FP32 | FP64>]`
...
<details>
<summary><strong><a href="/commands/json.strappend/">JSON.STRAPPEND</a></strong> - Appends a string to JSON strings at the paths matching a given path expression</summary>
...
<details>
<summary><strong><a href="/commands/json.strlen/">JSON.STRLEN</a></strong> - Returns the length of JSON strings at the paths matching a given path expression</summary>
...
**Syntax:** `FT.CREATE index [ON <HASH | JSON>] [PREFIX count prefix [prefix
  ...
  [SKIPINITIALSCAN] [INDEXALL <ENABLE | DISABLE>] SCHEMA field name [AS alias] <TEXT | TAG |
  NUMERIC | GEO | VECTOR> [WITHSUFFIXTRIE] [INDEXEMPTY]
  [INDEXMISSING] [SORTABLE [UNF]] [NOINDEX] [field name [AS alias]
...
<details>
<summary><strong><a href="/commands/ft.hybrid/">FT.HYBRID</a></strong> - Performs hybrid search combining text search and vector similarity search</summary>

**Syntax:** `FT.HYBRID index
  SEARCH query
    [SCORER scorer]
    [YIELD SCORE AS name]
  VSIM vector field $vector param
    [KNN count K k [EF RUNTIME ef runtime]]
    [RANGE count RADIUS radius [EPSILON epsilon]]
    [YIELD SCORE AS name]
    [FILTER filter]
  [COMBINE RRF count [CONSTANT constant] [WINDOW window] [YIELD SCORE AS name]]
  [COMBINE LINEAR count [[ALPHA alpha] [BETA beta]] [WINDOW window] [YIELD SCORE AS name]]
  [LIMIT offset num]
  ...
  [FILTER filter]
  PARAMS nargs vector param vector blob [name value ...]
  [TIMEOUT timeout]`
...
**Syntax:** `TS.ADD key timestamp value [RETENTION retentionPeriod]
  [ENCODING <UNCOMPRESSED | COMPRESSED>] [CHUNK SIZE size]
...
**Syntax:** `TS.ALTER key [RETENTION retentionPeriod] [CHUNK SIZE size]
  [DUPLICATE POLICY <BLOCK | FIRST | LAST | MIN | MAX | SUM>] [LABELS label value
  [label value ...]]`
...
**Syntax:** `TS.CREATE key [RETENTION retentionPeriod] [ENCODING <UNCOMPRESSED |
  COMPRESSED>] [CHUNK SIZE size] [DUPLICATE POLICY <BLOCK | FIRST |
...
**Syntax:** `TS.DECRBY key value [TIMESTAMP timestamp]
  [RETENTION retentionPeriod] [UNCOMPRESSED] [CHUNK SIZE size]
  [LABELS label value [label value ...]]`
...
**Syntax:** `TS.MRANGE fromTimestamp toTimestamp [LATEST] [FILTER BY TS Timestamp
  ...
  [EMPTY]] FILTER <l=v | l!=v | l= | l!= | l=(v1,v2,...) |
  l!=(v1,v2,...) [l=v | l!=v | l= | l!= | l=(v1,v2,...) |
  l!=(v1,v2,...) ...]> [GROUPBY label REDUCE reducer]`
...
**Syntax:** `TS.RANGE key fromTimestamp toTimestamp [LATEST]
  [FILTER BY TS Timestamp [Timestamp ...]] [FILTER BY VALUE min max]
  [COUNT count] [[ALIGN value] AGGREGATION aggregators bucketDuration [BUCKETTIMESTAMP] [EMPTY]]`
...
**Syntax:** `TS.REVRANGE key fromTimestamp toTimestamp [LATEST]
  [FILTER BY TS Timestamp [Timestamp ...]] [FILTER BY VALUE min max]
  [COUNT count] [[ALIGN value] AGGREGATION aggregators
...
<details>
<summary><strong><a href="/commands/vadd/">VADD</a></strong> - Add a new element to a vector set, or update its vector if it already exists.</summary>
...
<details>
<summary><strong><a href="/commands/vcard/">VCARD</a></strong> - Return the number of elements in a vector set.</summary>
...
<details>
<summary><strong><a href="/commands/vdim/">VDIM</a></strong> - Return the dimension of vectors in the vector set.</summary>
...
<details>
<summary><strong><a href="/commands/vemb/">VEMB</a></strong> - Return the vector associated with an element.</summary>
...
<details>
<summary><strong><a href="/commands/vgetattr/">VGETATTR</a></strong> - Retrieve the JSON attributes of elements.</summary>
...
<details>
<summary><strong><a href="/commands/vinfo/">VINFO</a></strong> - Return information about a vector set.</summary>
...
<details>
<summary><strong><a href="/commands/vismember/">VISMEMBER</a></strong> - Check if an element exists in a vector set.</summary>
...
<details>
<summary><strong><a href="/commands/vlinks/">VLINKS</a></strong> - Return the neighbors of an element at each layer in the HNSW graph.</summary>
...
<details>
<summary><strong><a href="/commands/vrandmember/">VRANDMEMBER</a></strong> - Return one or multiple random members from a vector set.</summary>
...
<details>
<summary><strong><a href="/commands/vrange/">VRANGE</a></strong> - Return elements in a lexicographical range</summary>
...
<details>
<summary><strong><a href="/commands/vrem/">VREM</a></strong> - Remove an element from a vector set.</summary>
...
<details>
<summary><strong><a href="/commands/vsetattr/">VSETATTR</a></strong> - Associate or remove the JSON attributes of elements.</summary>
...
<details>
<summary><strong><a href="/commands/vsim/">VSIM</a></strong> - Return elements by vector similarity.</summary>
...
<details>
<summary><strong><a href="/commands/hotkeys/">HOTKEYS</a></strong> - A container for hotkeys tracking commands.</summary>
...
<details>
<summary><strong><a href="/commands/hotkeys-get/">HOTKEYS GET</a></strong> - Returns lists of top K hotkeys depending on metrics chosen in HOTKEYS START command.</summary>
...
<details>
<summary><strong><a href="/commands/hotkeys-reset/">HOTKEYS RESET</a></strong> - Release the resources used for hotkey tracking.</summary>
...
<details>
<summary><strong><a href="/commands/hotkeys-start/">HOTKEYS START</a></strong> - Starts hotkeys tracking.</summary>
...
<details>
<summary><strong><a href="/commands/hotkeys-stop/">HOTKEYS STOP</a></strong> - Stops hotkeys tracking.</summary>
...
<details>
<summary><strong><a href="/commands/cluster-migration/">CLUSTER MIGRATION</a></strong> - Start, monitor, and cancel atomic slot migration tasks.</summary>

**Syntax:** `CLUSTER MIGRATION <IMPORT start-slot end-slot
...
<details>
<summary><strong><a href="/commands/cluster-slot-stats/">CLUSTER SLOT-STATS</a></strong> - Return an array of slot usage statistics for slots assigned to the current node.</summary>

**Syntax:** `CLUSTER SLOT-STATS <SLOTSRANGE start-slot end-slot | ORDERBY metric
